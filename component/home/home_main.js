      ...
      <div className="home-parent parent">
        <div className="home-cont cont">
          <div className="left">
            ...
            >
              <p className="desc">
              At DIwise Global (PRAJWAL KULKARNI), we're your strategic digital partner, elevating your brand to a global stage. With innovative solutions and a proven track record, we empower businesses to thrive in the digital landscape.
              </p>
            </motion.div>
            <motion.div
              initial={{ x: -100, opacity: 0 }}
